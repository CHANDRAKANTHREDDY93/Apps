                    ...
                    <div className="w-full p-2"> 
                        {
                            cartSelector.map((item: any) => (
                                <div className="flex justify-between pt-2">
                                    <div className="flex">
                                        <img src={`../../../assets/fruits/${item.image}.jpg`} className="h-48 w-[292px] p-2" alt={item.description}></img>
                                        <div className="flex font-bold text-x px-2">{item.name}
                                    ...
                                    <div className="flex flex-wrap items-center justify-center">
                                        ...
                                        <div className="flex justify-center items-center px-2">{item.quantity * item.price}$</div>
                                    </div>
                                </div>
                            ))
                        }
